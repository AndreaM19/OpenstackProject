...
public class OpenstackNetConstants {
	...
	public static final String PAGE_LABEL_NETWORK_CREATE="Networks - Create network";
	public static final String PAGE_LABEL_NETWORK_CREATE_MULTIPLE="Networks - Create multiple network";
	public static final String PAGE_LABEL_NETWORK_UPDATE="Networks - Update network";
	public static final String PAGE_LABEL_NETWORK_SHOW="Networks - Show network";
	
	public static final String PAGE_LABEL_SUBNET="Subnets";
	public static final String PAGE_LABEL_SUBNET_CREATE="Subnets - Create subnet";
	public static final String PAGE_LABEL_SUBNET_CREATE_MULTIPLE="Subnets - Create multiple subnet";
	public static final String PAGE_LABEL_SUBNET_UPDATE="Subnets - Update subnet";
	public static final String PAGE_LABEL_SUBNET_SHOW="Subnets - Show subnet";
	
	public static final String PAGE_LABEL_PORT="Ports";
	public static final String PAGE_LABEL_PORT_CREATE="Ports - Create port";
	public static final String PAGE_LABEL_PORT_CREATE_MULTIPLE="Ports - Create multiple port";
	public static final String PAGE_LABEL_PORT_UPDATE="Ports - Update port";
	public static final String PAGE_LABEL_PORT_SHOW="Ports - Show port";
	...
	public static final String HTML_PAGE_TITLE_NETWORK_UPDATE="<h3 id='sectionTitle' class='section-title'>"+OpenstackNetConstants.PAGE_LABEL_NETWORK_UPDATE+"</h3>";
	public static final String HTML_PAGE_TITLE_NETWORK_CREATE="<h3 id='sectionTitle' class='section-title'>"+OpenstackNetConstants.PAGE_LABEL_NETWORK_CREATE+"</h3>";
	public static final String HTML_PAGE_TITLE_NETWORK_CREATE_MULTIPLE="<h3 id='sectionTitle' class='section-title'>"+OpenstackNetConstants.PAGE_LABEL_NETWORK_CREATE_MULTIPLE+"</h3>";
	public static final String HTML_PAGE_TITLE_NETWORK_SHOW="<h3 id='sectionTitle' class='section-title'>"+OpenstackNetConstants.PAGE_LABEL_NETWORK_SHOW+"</h3>";
	...
	public static final String HTML_PAGE_TITLE_SUBNET_UPDATE="<h3 id='sectionTitle' class='section-title'>"+OpenstackNetConstants.PAGE_LABEL_SUBNET_UPDATE+"</h3>";
	public static final String HTML_PAGE_TITLE_SUBNET_CREATE="<h3 id='sectionTitle' class='section-title'>"+OpenstackNetConstants.PAGE_LABEL_SUBNET_CREATE+"</h3>";
	public static final String HTML_PAGE_TITLE_SUBNET_CREATE_MULTIPLE="<h3 id='sectionTitle' class='section-title'>"+OpenstackNetConstants.PAGE_LABEL_SUBNET_CREATE_MULTIPLE+"</h3>";
	public static final String HTML_PAGE_TITLE_SUBNET_SHOW="<h3 id='sectionTitle' class='section-title'>"+OpenstackNetConstants.PAGE_LABEL_SUBNET_SHOW+"</h3>";
	...
	public static final String HTML_PAGE_TITLE_PORT_CREATE_MULTIPLE="<h3 id='sectionTitle' class='section-title'>"+OpenstackNetConstants.PAGE_LABEL_PORT_CREATE_MULTIPLE+"</h3>";
	public static final String HTML_PAGE_TITLE_PORT_SHOW="<h3 id='sectionTitle' class='section-title'>"+OpenstackNetConstants.PAGE_LABEL_PORT_SHOW+"</h3>";
	...
	public static final String LABEL_IPADDRESS="IP Address";
	public static final String LABEL_PORTNAME="Port name";
	public static final String LABEL_PORTNUMBER="Port number";
	public static final String LABEL_TENANTID="Tenant Id";
	...
	public static final String BUTTON_PORT_CREATE="Create port";
	public static final String BUTTON_PORT_CREATE_MULTIPLE="Create multiple port";
	
	//Icons
	public static final String ICON_DELETE="/img/icon/delete.png";
	public static final String ICON_UPDATE="/img/icon/update.png";
	public static final String ICON_SHOW="/img/icon/show.png";
}
